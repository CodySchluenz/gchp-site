...
if(!isset($_SESSION['app'])){ ?>
	<br><br><br><br><h1>Grant County Holiday Project Online Application</h1><br><br>
	<!-- page content here -->
	<p>If you do not wish to fill out the application online, you may download the <a href="../docs/GRANT COUNTY HOLIDAY PROJECT APPLICATION.pdf" target="_blank">pdf application</a>. Then mail your application.
	<p>Below is the online application. There are 5 steps to the online application. Fill out each section then click next.</p>
...
try
	...
	$s->bindValue(':shoeSize', $_SESSION['app4'][$numMem][7]);
