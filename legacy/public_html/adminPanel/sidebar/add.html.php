...
<div id="maincontent">
<blockquote><h5> >> Add Information to the Sidebar </h5>
<div class="addSBTable">
<form  action="index.php" method="post">
<table class="addSBTable">
	<form  action="?edit" method="POST" name="updateForm">
		<tr><td> Add Information to the Sidebar </td></tr>

		<tr><td>Title<br>
		<textarea rows="1" cols="50" name="txtTitle"> </textarea></td></tr>
		
		
		<tr><td>Subtitle<br>
		
		<textarea rows="1" cols="50" name="txtSubtitle"> </textarea></td></tr>
		<tr><td>Paragraph<br>
		<textarea rows="6" cols="50" name="txtPara"> </textarea></td></tr>
